...
export const DICT = {
  es: {
    ...
    inversion: {
      ...
      cats: [
        { t: 'Lotes', d: 'Lotes en venta en Añelo y la zona de Vaca Muerta.', to: '/propiedades?type=Lote / Terreno' },
        { t: 'Departamentos', d: 'Unidades para invertir o rentar en el corazón de la actividad.', to: '/propiedades?type=Departamento' },
        { t: 'Fideicomisos', d: 'Súmese a proyectos de construcción con respaldo y escala. Lo coordina un asesor especializado.', to: '' },
      ],
    },
  ...
  en: {
    ...
    inversion: {
      ...
      cats: [
        { t: 'Lots', d: 'Lots for sale in Añelo and the Vaca Muerta area.', to: '/propiedades?type=Lote / Terreno' },
        { t: 'Apartments', d: 'Units to invest in or rent at the heart of the action.', to: '/propiedades?type=Departamento' },
        { t: 'Trusts (fideicomisos)', d: 'Join construction projects with backing and scale. Coordinated with a specialist advisor.', to: '' },
      ],
    },
