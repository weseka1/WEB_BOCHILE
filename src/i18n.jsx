...
export const DICT = {
  es: {
    nav: { comprar: 'Comprar', alquilar: 'Alquilar', tasaciones: 'Tasaciones', empresas: 'Empresas', nosotros: 'Nosotros', contacto: 'Contacto', wa: 'WhatsApp' },
    hero: {
    ...
    waMenu: { title: 'Estamos para ayudarlo', sub: 'Elija el área y un asesor lo atiende por WhatsApp.', ventas: 'Ventas', alquileres: 'Alquileres', tasaciones: 'Tasaciones', general: 'Consulta general', open: 'Abrir WhatsApp', close: 'Cerrar' },
    ...
    nosotros: {
      ...
      title1: 'Medio siglo', title2: 'de confianza.',
      ...
      story: [
        ...
        'Conocemos el mercado local como pocos. Esa experiencia —medio siglo comprando, vendiendo y tasando— es la que ponemos al servicio de cada persona que nos elige.',
      ...
      since: 'En Bahía Blanca · desde 1970',
      teamHead: 'Las personas detrás de Bochile',
      teamNote: 'El equipo que lo acompaña en cada operación.',
      why: [
        { t: '50 años de trayectoria', d: 'Medio siglo operando en Bahía Blanca nos respalda. La experiencia no se improvisa.' },
  ...
  en: {
    nav: { comprar: 'Buy', alquilar: 'Rent', tasaciones: 'Valuation', empresas: 'Business', nosotros: 'About', contacto: 'Contact', wa: 'WhatsApp' },
    hero: {
    ...
    waMenu: { title: 'We’re here to help', sub: 'Choose an area and an advisor will assist you on WhatsApp.', ventas: 'Sales', alquileres: 'Rentals', tasaciones: 'Valuations', general: 'General enquiry', open: 'Open WhatsApp', close: 'Close' },
    ...
    nosotros: {
      kicker: 'About us',
      title1: 'Half a century', title2: 'of trust.',
      ...
      story: [
        ...
        'We know the local market like few others. That experience —half a century buying, selling and valuing— is what we put at the service of everyone who chooses us.',
      ...
      since: 'In Bahía Blanca · since 1970',
      teamHead: 'The people behind Bochile',
      teamNote: 'The team that guides you through every deal.',
      why: [
        { t: '50 years of experience', d: 'Half a century operating in Bahía Blanca backs us. Experience can’t be improvised.' },
    ...
    tasa: { badge: 'Professional valuation', title1: 'What is your', title2: 'property worth?', sub: 'We arrange everything on WhatsApp, quick and simple. Half a century listing properties in Bahía Blanca backs us.', perks: ['Reply in under 24 hours', 'No-obligation service', 'The best price on the market'], formhead: 'Start here ↓', submit: 'Request my valuation', note: 'A Bochile advisor will assist you, no obligation.', f: { nombre: 'Your name', tel: 'WhatsApp', tipo: 'Property type', zona: 'Area or approximate address', opts: ['House', 'Apartment', 'Land', 'Retail / Office', 'Other'] } },
