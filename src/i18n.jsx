...
export const DICT = {
  es: {
    ...
    waMenu: { title: 'Hablá con nosotros', sub: 'Elegí el área y te atendemos al toque por WhatsApp.', ventas: 'Ventas', alquileres: 'Alquileres', tasaciones: 'Tasaciones', general: 'Consulta general', open: 'Abrir WhatsApp', close: 'Cerrar' },
  ...
  en: {
    ...
    waMenu: { title: 'Chat with us', sub: 'Pick an area and we’ll reply right away on WhatsApp.', ventas: 'Sales', alquileres: 'Rentals', tasaciones: 'Valuations', general: 'General enquiry', open: 'Open WhatsApp', close: 'Close' },
