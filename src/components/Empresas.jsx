...
// Sección B2B: empresas que buscan depósitos, galpones, oficinas, locales o pedidos a medida.
    ...
    <section className="section wrap" id="empresas">
      <div className="emp">
        <div className="emp-left">
          ...
          <a className="emp-cta reveal" data-cursor target="_blank" rel="noopener" href={waTo('ventas', e.waMsg)}>
            <WaIcon /> {e.cta}
          </a>
        </div>
        <div className="emp-grid">
          {e.cats.map((c, i) => {
            ...
            return c.to
              ...
              : <a className="emp-cell reveal" data-cursor target="_blank" rel="noopener" href={waTo('ventas', e.waMsg)} key={i}>{inner}</a>
          })}
        </div>
      </div>
    </section>
